...
const cspContent =
  process.env.NODE_ENV === "production"
    ? "default-src 'self' 'unsafe-inline'; img-src 'self' data: tile.openstreetmap.org; connect-src 'self'"
    : "default-src 'self' 'unsafe-inline' 'unsafe-eval'; img-src 'self' 'unsafe-eval' data: tile.openstreetmap.org; connect-src 'self'";
